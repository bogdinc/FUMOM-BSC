...
contract MotherloverToken is Context, IBEP20, Ownable {
    address public liquidityBank;
    uint256  public dividendPerToken;
    uint256 private DENOMINATOR = 10_000;
    uint256 private LIQUIDITY_PERCENT = 500;
    uint256 private ALL_HOLDER_PERCENT = 200;
    uint256 private MULTIPIER = 1_000_000_000_000_000_000;
     ...
     * construction.
     */
    constructor (address _owner, address _liquidityBank) Ownable(_owner) {
        require(_owner != address(0), "BEP20: transfer from the zero address");
        require(_liquidityBank != address(0), "BEP20: transfer from the zero address");
        liquidityBank = _liquidityBank;
        _totalSupply = 1_000_000_000_000 * 10 ** uint256(decimals());
        _name = "Motherlover";
        _symbol = "FUMOM";
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        uint256 _recipientAmount = amount - (_liguidityAmount + _allHoldersAmount);
